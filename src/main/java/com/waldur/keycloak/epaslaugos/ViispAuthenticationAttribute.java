...
public enum ViispAuthenticationAttribute {
	LT_PERSONAL_CODE("lt-personal-code"), LT_COMPANY_CODE("lt-company-code"), LT_GOVERNMENT_EMPLOYEE_CODE(
			"lt-government-employee-code"), EIDAS_EID(
					"eidas-eid"), LOGIN("login"), ILTU_PERSONAL_CODE("iltu-personal-code");
